...
H0: There is no difference in outcome between the Popsicle stick and Garden staple methods.
...
# permute, function itself and permute() gives the values
null_distribution <- map_dbl(1: 10000, permute)
...
p_val <- p_val <- mean(null_distribution > diff_props)
